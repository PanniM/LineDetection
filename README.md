The Program waits an absolute path to the folder name containing the image files (recognise them by containing the img substring given in the example cognex files).
